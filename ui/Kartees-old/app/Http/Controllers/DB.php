...
class database{
	...
	private function send($request, $method = "GET", $endpoint = null){
        $this->curl = curl_init();
        curl_setopt_array($this->curl, array(
          CURLOPT_URL => "https://cdcde260-6832-446f-955e-28af0193fe6a-bluemix:c22f953dd39391d9e1fe1ebc77835baccce56378ffbb48c3bb7cae936d5785d2@cdcde260-6832-446f-955e-28af0193fe6a-bluemix.cloudant.com/kartees".$endpoint,
          ...
          CURLOPT_HTTPHEADER => array(
            ...
            "password: c22f953dd39391d9e1fe1ebc77835baccce56378ffbb48c3bb7cae936d5785d2",
            "username: cdcde260-6832-446f-955e-28af0193fe6a-bluemix"
          ),
        ));
