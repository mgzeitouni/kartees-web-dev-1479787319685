...
.select2-offscreen{
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="navbar col-sm-12 navbar-fixed-top" role="navigation">
                            <div class="navbar-header">
                                ...
                                <a class="brand" href=""><img src="<?= $this->config->item("base_url"); ?>/img/logo@2x.png" width="50" height="50" alt=""> Kartees</a>
                            </div>
                            <div class="collapse navbar-collapse">
                                <ul class="nav pull-right">
										
			<li><a href='<?= $this->config->item("base_url"); ?>'>Welcome, </a></li>
			<li><a href='<?= $this->config->item("base_url"); ?>/login/logout'>Logout</a></li>
		...
		<script src="<?= $this->config->item('base_url') ?>/flat-ui/js/application.js"></script>
		<script src="<?= $this->config->item('base_url') ?>/flat-ui/bootstrap/js/google-code-prettify/prettify.js"></script>
