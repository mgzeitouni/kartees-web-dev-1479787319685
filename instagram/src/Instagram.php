...
class Instagram
{
    ...
    public function __construct($config = null)
    {
        if (is_array($config)) {
            ...
            $this->setApiKey("3d150488d6e44fdb8d31ccc76856f46a");
            $this->setApiSecret("ef72e2f8cb2e4240a1755b2b948d1138");
            $this->setApiCallback("http://localhost/instagram/action.php");
        } else {
